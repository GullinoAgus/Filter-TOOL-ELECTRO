...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.InputFreqLine = QtWidgets.QLineEdit(self.page_3)
        self.InputFreqLine.setObjectName("InputFreqLine")
        self.gridLayout_6.addWidget(self.InputFreqLine, 0, 1, 1, 1)
        self.label_5 = QtWidgets.QLabel(self.page_3)
        self.label_5.setObjectName("label_5")
        self.gridLayout_6.addWidget(self.label_5, 1, 0, 1, 1)
        self.InputAmpline = QtWidgets.QLineEdit(self.page_3)
        self.InputAmpline.setObjectName("InputAmpline")
        self.gridLayout_6.addWidget(self.InputAmpline, 1, 1, 1, 1)
        ...
        self.inputComboBox = QtWidgets.QComboBox(self.groupBox_2)
        self.inputComboBox.setMinimumSize(QtCore.QSize(100, 0))
        ...
        self.vertLayoutPlots = QtWidgets.QVBoxLayout()
        self.vertLayoutPlots.setSizeConstraint(QtWidgets.QLayout.SizeConstraint.SetMinimumSize)
        self.vertLayoutPlots.setSpacing(6)
        self.vertLayoutPlots.setObjectName("vertLayoutPlots")
        ...
        self.vertLayoutPlots.addWidget(self.PolesAndZerosBox)
        ...
        self.vertLayoutPlots.addWidget(self.BodePlotBox)
        ...
        self.vertLayoutPlots.addWidget(self.InputAndOutputBox)
        self.gridLayout_11.addLayout(self.vertLayoutPlots, 0, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.inputComboBox.setItemText(0, _translate("MainWindow", "Cos"))
        self.inputComboBox.setItemText(1, _translate("MainWindow", "Pulse"))
        self.inputComboBox.setItemText(2, _translate("MainWindow", "Periodic Pulse"))
        self.inputComboBox.setItemText(3, _translate("MainWindow", "Triangle Periodic Pulse"))
